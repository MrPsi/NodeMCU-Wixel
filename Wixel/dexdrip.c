...
// 1 is recommended                                                                                 //
//                                                                                                  //
  static volatile BIT status_lights = 0;                                                            //
...
//                                                                                                  //
  static volatile BIT force_alternate_usb_protocol = 1;                                             //
// if set to 1, alternate usb protocol is always used and no bluetooth initialazion is performed    //
//                                                                                                  //
//..................................................................................................//
//////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////
...
void print_packet(Dexcom_packet* pPkt) {
    uartEnable();
    if(force_alternate_usb_protocol == 0 && (allow_alternate_usb_protocol == 0 || !usbPowerPresent())) {
...
void goToSleep (int seconds) {
    ...
    if(!needsTimingCalibration) {
        if(!usbPowerPresent()){
            ...
            delayMs(100);
            while((getMs() - start_waiting) < (seconds * 1000l)) {
                doServices();
            }
        }
    }
...
void main() {
    ...
    delayMs(1000);
	if(force_alternate_usb_protocol == 0) {
		configBt();
	}
